...
- (void)viewDidLoad
{
    ...
    self.arrayImages = [NSArray arrayWithObjects:[UIImage imageNamed:@"3.png"],[UIImage imageNamed:@"1.png"],[UIImage imageNamed:@"2.png"],[UIImage imageNamed:@"3.png"],[UIImage imageNamed:@"1.png"], nil];
    
        
    _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 10, self.view.frame.size.width,ImageHeight)];
    NSLog(@"scollView width = %f", _scrollView.frame.size.width);
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.scrollView.frame.size.height, self.scrollView.frame.size.width, 20)];
    ...
    _timer = [NSTimer scheduledTimerWithTimeInterval:50 target:self selector:@selector(scrollPages) userInfo:nil repeats:YES];
    ...
    //_scrollView.contentOffset.x = _scrollView.frame.size.width;
...
-(void)loadScrollViewPage:(NSInteger)page
{
    if (page >= self.arrayImages.count) {
        page = page % self.arrayImages.count;
    }
...
- (void)loadScrollViewPage:(NSInteger)page {
    ...
    if (imageViewController.view.superview == nil) {
        ...
        imageView.image = [self.arrayImages objectAtIndex:page];
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
    ...
    NSLog(@"page = %ld,distance = %f", page,self.scrollView.contentOffset.x/pageWidth);
